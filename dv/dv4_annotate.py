...
custom yolo model(x6) auto labeling version
"""
import json
import os
import sys
...
def main(opt=None):
    ...
    for IMGS_DIR in IMGS_DIRS:
        ...
        for idx, i in enumerate(IMGS):
            ...
            if k == ord("q"):
                get_logger().info("-- Click q key, CV2 Stop --")
                is_out = True
                break
            elif k == ord(" "):
                ...
                get_logger().info(f"Pass this image({i}). you will see again this image when you label this dir again.")
                continue

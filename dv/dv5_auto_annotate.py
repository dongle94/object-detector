...
def main(opt=None):
    get_logger().info(f"Start dv5 auto annotation script.")
    ...
    if os.path.exists(opt.json_file):
        ...
        basic_fmt = {
            "info": {"year": "2023", "version": "1",
                     "description": "datavoucher human group gender object detection dataset.",
                     "contributor": "",
                     "url": "",
        ...
        for idx, i in _imgs:
            ...
            for d in _det:
                ...
                if detector.names[_cls_idx] == 'homo':
                    category_id = 1
                    b_color = (216, 16, 16)
                elif detector.names[_cls_idx] == 'hetero':
                    category_id = 2
                    b_color = (16, 16, 216)

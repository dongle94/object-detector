...
if __name__ == "__main__":
    ...
    yolov5 = Yolov5TRT(
        ...
        agnostic=cfg.yolo_agnostic_nms, max_det=cfg.yolo_max_det, classes=yolo_nms_iou.det_obj_classes
    )
    yolov5.warmup(img_size=(1, 3, cfg.yolo_img_size, cfg.yolo_img_size))

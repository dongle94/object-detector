...
# from core.yolov8.utils import LOGGER, TQDM, clean_url, emojis, url2file
from core.yolov8.yolov8_utils import TQDM, clean_url, emojis, is_online, url2file
from core.yolov8.yolov8_utils import checks
    ...
    if "://" not in str(url) and Path(url).is_file():  # URL exists ('://' check required in Windows Python<3.10)
        ...
        for i in range(retry + 1):
            try:
                ...
                print(f"Wanring: ⚠️ Download failure, retrying {i + 1}/{retry} {url}...")
